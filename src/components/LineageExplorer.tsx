  ...
  return (
    <div className="relative w-full h-full min-h-[calc(100vh-2rem)] flex overflow-hidden">
      ...
      <div className="absolute top-4 left-4 z-20 flex flex-wrap items-center gap-2 bg-white/95 dark:bg-slate-900/95 backdrop-blur p-2 rounded-2xl border border-slate-200 dark:border-slate-800 shadow-xl max-w-[calc(100vw-6rem)]">
        ...
        <button
          id="reset-dag-layout-btn"
          onClick={handleResetPositions}
          className="flex items-center gap-1.5 px-2.5 py-1.5 bg-slate-100 hover:bg-slate-200 dark:bg-slate-800 dark:hover:bg-slate-700 text-slate-700 dark:text-slate-200 rounded-xl text-xs font-mono font-semibold border border-slate-200 dark:border-slate-700 transition-colors cursor-pointer"
          title="Khôi phục vị trí các bảng về bố cục phân tầng chuẩn"
        >
          <RotateCcw className="w-3.5 h-3.5 text-indigo-500" />
          <span className="hidden sm:inline">Reset vị trí</span>
        </button>
      ...
      <div className="absolute bottom-4 left-4 z-20 flex flex-wrap items-center gap-3 px-3.5 py-2 bg-white/95 dark:bg-slate-900/95 backdrop-blur rounded-2xl border border-slate-200 dark:border-slate-800 text-[11px] text-slate-600 dark:text-slate-300 shadow-md">
      ...
      <div className={`h-full transition-all duration-300 ${
        ...
        >
          ...
          />
          <Controls className="!bg-white dark:!bg-slate-900 !border-slate-200 dark:!border-slate-800 !rounded-2xl !shadow-lg" />
          <MiniMap
            nodeStrokeColor={darkMode ? '#475569' : '#cbd5e1'}
            nodeColor={darkMode ? '#1e293b' : '#f1f5f9'}
            nodeBorderRadius={4}
            className="!bg-white/90 dark:!bg-slate-900/90 !border-slate-200 dark:!border-slate-800 !rounded-2xl !shadow-lg"
          />
        </ReactFlow>
      </div>
